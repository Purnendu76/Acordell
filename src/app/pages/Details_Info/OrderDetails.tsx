...
const FALLBACK_IMAGE =
  "https://images.unsplash.com/photo-1594035910387-fea47794261f?w=200&auto=format&fit=crop&q=80";
...
export default function OrderDetailsScreen() {
  ...
  const fetchOrderDetails = useCallback(async () => {
    ...
    try {
      const response = await axios.get<Order[]>(
        "https://n8n.srv917960.hstgr.cloud/webhook/acordell-get-orders",
      );
  ...
  const deliveryDateMeta = order.meta_data.find(
    (m) => m.key === "Delivery Date",
  );
  const deliveryTimeMeta = order.meta_data.find(
    (m) => m.key === "Delivery Time Slot",
  );
      ...
      >
          ...
          <View style={styles.card}>
            ...
            <View style={styles.deliveryRow}>
              ...
              <View style={styles.deliveryInfo}>
                ...
                {deliveryTimeMeta && (
                  <ThemedText style={styles.deliverySubtext}>
                    Time Slot: {deliveryTimeMeta.value}
                  </ThemedText>
                )}
              </View>
            </View>
        ...
        <View style={[styles.card, { marginBottom: 30 }]}>
          ...
          <View style={styles.priceRow}>
            ...
            <ThemedText style={[styles.priceValue, { color: "#10b981" }]}>
              FREE
            </ThemedText>
          </View>
          <View style={styles.divider} />
